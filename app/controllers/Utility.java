...
public class Utility {
	...
	public static void sendEmail(String emailId, String company, String key) {
		...
		try {
			...
			email.setMsg(" Hi,\n You have been added on www.tbd.com for "
					+ company + " to submit your time cards. \n Please go to "
					+ signupUrl + "usersignup2/" + key
	...
	public static void sendEmailForApproval(String emailId, String company,
			String employee) {
		SimpleEmail email = new SimpleEmail();
		try {
			email.setFrom("no-reply@tbd.com");
			...
			email.setMsg("The user "
					+ employee
					+ " who is registerdd for "
					+ company
